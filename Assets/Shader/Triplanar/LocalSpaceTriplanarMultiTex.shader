...
Shader "Ukemi/BGolus/Localspace Triplanar (Multi-Texture)" {
Properties {
        ...
        _DepthPower("Depth Scale", Float) = 1
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			half4 depthLine =1 - saturate(_DepthPower * (depth - IN.scrPos.w));// foam line by comparing depth and screenposition	
